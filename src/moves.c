...
/*   Updated: 2022/03/08 12:05:48 by hubretec         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	move_up(t_game *game)
{
	...
	mlx_put_image_to_window(game->mlx, game->mlx_win, game->player.back.img,
...
void	move_left(t_game *game)
{
	...
	mlx_put_image_to_window(game->mlx, game->mlx_win, game->player.left.img,
		game->player.pos.x, game->player.pos.y);
	if (game->map.map[y_map][x_map] == game->map.assets.exit.value)
		mlx_put_image_to_window(game->mlx, game->mlx_win,
			game->map.assets.exit.img, prev_pos.x, prev_pos.y);
...
void	move_right(t_game *game)
{
	...
	prev_pos = game->player.pos;
	game->player.pos.x += game->map.assets.size;
	mlx_put_image_to_window(game->mlx, game->mlx_win, game->player.right.img,
		game->player.pos.x, game->player.pos.y);
	if (game->map.map[y_map][x_map] == game->map.assets.exit.value)
		mlx_put_image_to_window(game->mlx, game->mlx_win,
			game->map.assets.exit.img, prev_pos.x, prev_pos.y);
